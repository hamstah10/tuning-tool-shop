...
return [
    ...
    'columns' => [
        ...
        'client_id' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_paymentmethod.client_id',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'max' => 500,
        ...
        'secret' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_paymentmethod.secret',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'max' => 500,
        ...
        'api_url' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_paymentmethod.api_url',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'max' => 2048,
        ...
        'is_sandbox' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_paymentmethod.is_sandbox',
            'config' => [
                'type' => 'check',
                'renderType' => 'checkboxToggle',
                'items' => [
        ...
        '1' => [
            'showitem' => '
                --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                    ...
                    icon,
                    --palette--;;settings,
                --div--;LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_paymentmethod.credentials,
                    client_id,
                    secret,
                    api_url,
                    is_sandbox,
