...
return [
    ...
    'columns' => [
        ...
        'product_type' => [
            ...
            'config' => [
                ...
                'items' => [
                    ...
                    ['label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_product.product_type.configurable', 'value' => 'configurable'],
                    ['label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_product.product_type.digital', 'value' => 'digital'],
        ...
        'lexoffice_product_id' => [
            'exclude' => true,
            'label' => 'Lexoffice Produkt-ID',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'max' => 36,
        ...
        'options' => [
            ...
            'label' => 'LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tx_tuningtoolshop_domain_model_product.options',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_tuningtoolshop_domain_model_productoption',
                'foreign_field' => 'product',
                'maxitems' => 999,
                'appearance' => [
                    'collapseAll' => true,
            ...
            'showitem' => '
                 ...
                 --div--;LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tabs.starter_package,
                    ...
                    --div--;LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tabs.relations,
                           ...
                           related_products,
                           lexoffice_product_id,
                    --div--;LLL:EXT:tuning_tool_shop/Resources/Private/Language/locallang_db.xlf:tabs.options,
                       options,
