...
class ModController extends ActionController 
{
	...
	{
		$this->pageRenderer->loadJavaScriptModule('@nng/nnrestapi/Axios.js');
		$this->pageRenderer->loadJavaScriptModule('@nng/nnrestapi/Nnrestapi.js');
	 ...
	 * @return string
	 */
	public function docsAction( string $identifier = '' ) 
	{
